...
int char_sym[CHAR_SYMBOL_NUMBER + 1] = {NULL_SYM, PLUS_SYM, MINUS_SYM, MUL_SYM, DIV_SYM, EQUAL_SYM, NOTEQ_SYM, LESS_SYM, BIG_SYM, LEFTP_SYM, RIGHTP_SYM, COMMA_SYM, SEMICOLON_SYM, PERIOD_SYM};
